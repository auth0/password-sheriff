...
describe('"maximum password length (bytes)" rule', function () {
  ...
  describe('assert (TextEncoder undefined fallback)', function () {
    var originalTextEncoder;
    before(function () { originalTextEncoder = global.TextEncoder; global.TextEncoder = undefined; });
    after(function () { global.TextEncoder = originalTextEncoder; });
  ...
  describe('unicode byte length tests (TextEncoder undefined fallback)', function () {
    var originalTextEncoder;
    before(function () { originalTextEncoder = global.TextEncoder; global.TextEncoder = undefined; });
    after(function () { global.TextEncoder = originalTextEncoder; });
